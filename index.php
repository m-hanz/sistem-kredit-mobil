      ...
      <form>
        <div class="w-full lg:w-2/3 lg:m-auto">
          <div class="w-full px-4 mb-8">
            <label for="name" class="text-base font-bold text-slate-900">Nama</label>
            <input
              type="text"
              id="name"
    ...
    <div class="container">
        ...
        <div class="w-full px-4 mb-12 md:w-1/3">
          ...
          <ul class="text-white">
            <li>
              <a
                href="#home"
                class="inline-block text-base hover:text-slate-900 mb-3">Home</a>
            </li>
            <li>
              <a
                href="#about"
            ...
            <li>
              <a
                href="#contact"
                class="inline-block text-base hover:text-slate-900 mb-3">Contact</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="w-full pt-6 border-t border-slate-200">
        <p class="font-medium text-xs text-white text-center">
          ...
          <a href="#" target="_blank" class="font-bold text-primary">luxemotion</a>, menggunakan
          <a href="https://tailwindcss.com" class="font-bold text-slate-900">Tailwind CSS</a>.
        </p>
      </div>
    </div>
  </footer>
